...
$t_periode_edit = NULL; // Initialize page object first

class ct_periode_edit extends ct_periode {
	...
	// Page object name
	var $PageObjName = 't_periode_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// per_mulai
			$this->per_mulai->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->per_mulai->CurrentValue, 7), ew_CurrentDate(), $this->per_mulai->ReadOnly);

			// per_selesai
			$this->per_selesai->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->per_selesai->CurrentValue, 7), ew_CurrentDate(), $this->per_selesai->ReadOnly);
...
// Create page object
if (!isset($t_periode_edit)) $t_periode_edit = new ct_periode_edit();

// Page init
$t_periode_edit->Page_Init();

// Page main
$t_periode_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_periode_edit->Page_Render();
?>
...
var CurrentForm = ft_periodeedit = new ew_Form("ft_periodeedit", "edit");

// Validate form
ft_periodeedit.Validate = function() {
...
ft_periodeedit.Form_CustomValidate = 
...
ft_periodeedit.ValidateRequired = true;
<?php } else { ?>
ft_periodeedit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $t_periode_edit->ShowPageHeader(); ?>
<?php
$t_periode_edit->ShowMessage();
?>
<?php if (!$t_periode_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_periode_edit->Pager)) $t_periode_edit->Pager = new cPrevNextPager($t_periode_edit->StartRec, $t_periode_edit->DisplayRecs, $t_periode_edit->TotalRecs) ?>
<?php if ($t_periode_edit->Pager->RecordCount > 0 && $t_periode_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_periode_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_periode_edit->PageUrl() ?>start=<?php echo $t_periode_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_periode_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_periode_edit->PageUrl() ?>start=<?php echo $t_periode_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_periode_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_periode_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_periode_edit->PageUrl() ?>start=<?php echo $t_periode_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_periode_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_periode_edit->PageUrl() ?>start=<?php echo $t_periode_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_periode_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft_periodeedit" id="ft_periodeedit" class="<?php echo $t_periode_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_periode_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_periode_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft_periodeedit", "x_per_mulai", 7);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ft_periodeedit", "x_per_selesai", 7);
</script>
<?php } ?>
</span>
...
<input type="hidden" data-table="t_periode" data-field="x_per_id" name="x_per_id" id="x_per_id" value="<?php echo ew_HtmlEncode($t_periode->per_id->CurrentValue) ?>">
<?php if (!$t_periode_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_periode_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t_periode_edit->Pager)) $t_periode_edit->Pager = new cPrevNextPager($t_periode_edit->StartRec, $t_periode_edit->DisplayRecs, $t_periode_edit->TotalRecs) ?>
<?php if ($t_periode_edit->Pager->RecordCount > 0 && $t_periode_edit->Pager->Visible) { ?>
