...
//
// Table class for t_audit_trail
//
class ct_audit_trail extends cTable {
	var $id;
	var $datetime;
	var $script;
	var $user;
	...
	function __construct() {
		...
		$this->TableVar = 't_audit_trail';
		$this->TableName = 't_audit_trail';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_audit_trail`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t_audit_trail', 't_audit_trail', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// datetime
		$this->datetime = new cField('t_audit_trail', 't_audit_trail', 'x_datetime', 'datetime', '`datetime`', ew_CastDateFieldForLike('`datetime`', 0, "DB"), 135, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// script
		$this->script = new cField('t_audit_trail', 't_audit_trail', 'x_script', 'script', '`script`', '`script`', 200, -1, FALSE, '`script`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->script->Sortable = TRUE; // Allow sort
		$this->fields['script'] = &$this->script;

		// user
		$this->user = new cField('t_audit_trail', 't_audit_trail', 'x_user', 'user', '`user`', '`user`', 200, -1, FALSE, '`user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user->Sortable = TRUE; // Allow sort
		$this->fields['user'] = &$this->user;

		// action
		$this->action = new cField('t_audit_trail', 't_audit_trail', 'x_action', 'action', '`action`', '`action`', 200, -1, FALSE, '`action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->action->Sortable = TRUE; // Allow sort
		$this->fields['action'] = &$this->action;

		// table
		$this->_table = new cField('t_audit_trail', 't_audit_trail', 'x__table', 'table', '`table`', '`table`', 200, -1, FALSE, '`table`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_table->Sortable = TRUE; // Allow sort
		$this->fields['table'] = &$this->_table;

		// field
		$this->_field = new cField('t_audit_trail', 't_audit_trail', 'x__field', 'field', '`field`', '`field`', 200, -1, FALSE, '`field`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_field->Sortable = TRUE; // Allow sort
		$this->fields['field'] = &$this->_field;

		// keyvalue
		$this->keyvalue = new cField('t_audit_trail', 't_audit_trail', 'x_keyvalue', 'keyvalue', '`keyvalue`', '`keyvalue`', 201, -1, FALSE, '`keyvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->keyvalue->Sortable = TRUE; // Allow sort
		$this->fields['keyvalue'] = &$this->keyvalue;

		// oldvalue
		$this->oldvalue = new cField('t_audit_trail', 't_audit_trail', 'x_oldvalue', 'oldvalue', '`oldvalue`', '`oldvalue`', 201, -1, FALSE, '`oldvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->oldvalue->Sortable = TRUE; // Allow sort
		$this->fields['oldvalue'] = &$this->oldvalue;

		// newvalue
		$this->newvalue = new cField('t_audit_trail', 't_audit_trail', 'x_newvalue', 'newvalue', '`newvalue`', '`newvalue`', 201, -1, FALSE, '`newvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_audit_trail`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_audit_trailview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_audit_trailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_audit_trailadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_audit_trailadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_audit_trailedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_audit_trailadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_audit_traildelete.php", $this->UrlParm());
	}
