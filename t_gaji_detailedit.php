...
$t_gaji_detail_edit = NULL; // Initialize page object first

class ct_gaji_detail_edit extends ct_gaji_detail {
	...
	// Page object name
	var $PageObjName = 't_gaji_detail_edit';
...
// Create page object
if (!isset($t_gaji_detail_edit)) $t_gaji_detail_edit = new ct_gaji_detail_edit();

// Page init
$t_gaji_detail_edit->Page_Init();

// Page main
$t_gaji_detail_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_gaji_detail_edit->Page_Render();
?>
...
var CurrentForm = ft_gaji_detailedit = new ew_Form("ft_gaji_detailedit", "edit");

// Validate form
ft_gaji_detailedit.Validate = function() {
...
ft_gaji_detailedit.Form_CustomValidate = 
...
ft_gaji_detailedit.ValidateRequired = true;
<?php } else { ?>
ft_gaji_detailedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_gaji_detailedit.Lists["x_peg_id"] = {"LinkField":"x_peg_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_peg_nama","x_peg_jabatan","x_peg_upah",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_pegawai"};
...
<?php if (!$t_gaji_detail_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_gaji_detail_edit->ShowPageHeader(); ?>
<?php
$t_gaji_detail_edit->ShowMessage();
?>
<?php if (!$t_gaji_detail_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_gaji_detail_edit->Pager)) $t_gaji_detail_edit->Pager = new cPrevNextPager($t_gaji_detail_edit->StartRec, $t_gaji_detail_edit->DisplayRecs, $t_gaji_detail_edit->TotalRecs) ?>
<?php if ($t_gaji_detail_edit->Pager->RecordCount > 0 && $t_gaji_detail_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_gaji_detail_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_gaji_detail_edit->PageUrl() ?>start=<?php echo $t_gaji_detail_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_gaji_detail_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_gaji_detail_edit->PageUrl() ?>start=<?php echo $t_gaji_detail_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_gaji_detail_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_gaji_detail_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_gaji_detail_edit->PageUrl() ?>start=<?php echo $t_gaji_detail_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_gaji_detail_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_gaji_detail_edit->PageUrl() ?>start=<?php echo $t_gaji_detail_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_gaji_detail_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft_gaji_detailedit" id="ft_gaji_detailedit" class="<?php echo $t_gaji_detail_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_gaji_detail_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_gaji_detail_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t_gaji_detail" data-field="x_gjd_id" name="x_gjd_id" id="x_gjd_id" value="<?php echo ew_HtmlEncode($t_gaji_detail->gjd_id->CurrentValue) ?>">
<?php if (!$t_gaji_detail_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_gaji_detail_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t_gaji_detail_edit->Pager)) $t_gaji_detail_edit->Pager = new cPrevNextPager($t_gaji_detail_edit->StartRec, $t_gaji_detail_edit->DisplayRecs, $t_gaji_detail_edit->TotalRecs) ?>
<?php if ($t_gaji_detail_edit->Pager->RecordCount > 0 && $t_gaji_detail_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
ft_gaji_detailedit.Init();
</script>
<?php
$t_gaji_detail_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_gaji_detail_edit->Page_Terminate();
?>
